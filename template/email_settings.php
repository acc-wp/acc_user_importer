...
if (empty($email_active)) {
    add_option("acc_email_activation", []);
    $email_active = get_option("acc_email_activation");
}
...
$page_url =
    get_site_url() . "/wp-admin/options-general.php?page=email_templates";
				...
				<tbody>
					...
					<tr>
						<th scope="row">
							...
							<input name="welcome_email_activation" type="checkbox" <?php if (
           !empty($welcome_active)
       ) {
           echo "checked";
       } ?>>
							</div>
					...
					<tr>
						<th scope="row">
							...
							<input name="expired_email_activation" type="checkbox" <?php if (
           !empty($expired_active)
       ) {
           echo "checked";
       } ?>>
							</div>
